...
const About = () => {
    ...
    return(
    <Flex as='section' id="aboutid" wrap='wrap' justify={'center'} align='center' p={'0px 100px 40px 100px'}>
        <Text as='h2'>Sobre mi</Text>
        <Img w='28%' h='100%' m='0px 20px 40px 80px' src="img/imgAbout.jpeg" alt="foto"/>
